...
public class Main {
    public static void main(String[] args) {
        ...
        Hotel hotel = new Hotel(1, "Hotel Ynoved", "23 rue de la poo", 1400);

        Voyage voyage = new Voyage(1, "BenglaCity", "Séjour complet", dest, vol, hotel);
        Client client = new Client(1, "de la haute valée", "Jean Eude Christophe Matteo", "john@exemple.com");
